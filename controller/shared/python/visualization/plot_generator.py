...
from controller.shared.python.visualization.actuator_plots import (
...
from controller.shared.python.visualization.command_utils import (
    get_thruster_count as infer_thruster_count,
)
from controller.shared.python.visualization.diagnostics_plots import (
...
from controller.shared.python.visualization.plot_data_utils import (
...
from controller.shared.python.visualization.state_plots import (
...
from controller.shared.python.visualization.threshold_overlays import add_limit_overlay
from controller.shared.python.visualization.trajectory_plots import (
...
class PlotGenerator:
    """
    Generates performance analysis plots from controller.shared.python.simulation.data.
    ...
    def generate_pwm_duty_cycles_from_physics(self, plot_dir: Path) -> None:
        """Fallback: Generate PWM plot from controller.shared.python.physics.data Thruster_X_Cmd columns."""
