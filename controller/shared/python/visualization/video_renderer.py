...
class VideoRenderer:
    """
    Generates MP4 animations from controller.shared.python.simulation.data.
    ...
    def __init__(
        ...
        thrusters: dict[int, list[float]] | None = None,
    ...
    def _get_thruster_count(self) -> int:
        """Determine thruster count from controller.configs.or fallback."""
