...
class UnifiedVisualizationGenerator:
    ...
    def __init__(
        ...
        self.fps: float | None = (
            None  # Will be calculated from controller.shared.python.simulation.timestep
        )
    ...
    def draw_satellite(
        ...
        # Check shape from controller.configs.
        shape = "sphere"
    ...
    def _get_plot_generator(self):
        ...
        if self._plot_generator is None:
            from controller.shared.python.visualization.plot_generator import (
                PlotGenerator,
            )
    ...
    def _get_video_renderer(self):
        ...
        if self._video_renderer is None:
            from controller.shared.python.visualization.video_renderer import (
                VideoRenderer,
            )
