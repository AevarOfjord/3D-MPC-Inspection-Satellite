...
from controller.configs.physics import THRUSTER_COUNT
from controller.shared.python.control_common.base import Controller
from controller.shared.python.runtime.policy import ActuatorPolicy
...
class MPCRunner:
    ...
    Decoupled from controller.shared.python.simulation.physics loop. Manages its own state including
    ...
    def __init__(
        ...
        Args:
            mpc_controller: Initialized controller instance.
        ...
        """
        self.mpc: Controller = mpc_controller
        ...
        try:
            ...
            mpc_info = {
                ...
                "controller_profile": str(
                    getattr(self.mpc, "controller_profile", "unknown")
                ),
                "linearization_mode": str(
                    getattr(self.mpc, "linearization_mode", "unknown")
                ),
