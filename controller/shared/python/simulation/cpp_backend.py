...
try:
    from controller.shared.python.cpp._cpp_sim import SatelliteParams, SimulationEngine
...
class CppSatelliteSimulator:
    ...
    def _create_satellite_params(self, cfg: AppConfig):
        ...
        # Inertia from controller.configs.is scalar float (isotropic assumption for now or principal axis)
        # C++ expects Vector3d.
