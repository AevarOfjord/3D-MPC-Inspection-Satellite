...
from controller.shared.python.simulation.data_logger import DataLogger
...
class SimulationLogger:
    ...
    def log_step(
        ...
        log_entry = {
            ...
            "Error_WY": error_wy,
            "Error_WZ": error_wz,
            "Frame_Origin_X": context.frame_origin[0],
    ...
    def log_physics_step(
        ...
        origin_x = frame_origin[0] if frame_origin is not None else 0.0
