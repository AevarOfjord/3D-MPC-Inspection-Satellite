...
from controller.configs import constants, physics, timing
...
def create_default_app_config() -> AppConfig:
    ...
    mpc = MPCParams(
        ...
        ref_tangent_lookahead_m=constants.Constants.REF_TANGENT_LOOKAHEAD_M,
        ref_tangent_lookback_m=constants.Constants.REF_TANGENT_LOOKBACK_M,
        ref_quat_max_rate_rad_s=constants.Constants.REF_QUAT_MAX_RATE_RAD_S,
        ref_quat_terminal_rate_scale=constants.Constants.REF_QUAT_TERMINAL_RATE_SCALE,
    ...
    controller_contracts = ControllerContractsParams(
        ...
        path_projection_lead_cap_m=constants.Constants.PATH_PROJECTION_LEAD_CAP_M,
