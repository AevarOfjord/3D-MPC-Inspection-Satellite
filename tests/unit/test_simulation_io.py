...
class TestSimulationIODirectories:
    ...
    @patch("satellite_control.core.simulation.io.datetime")
    def test_create_data_directories(self, mock_datetime, simulation_io, tmp_path):
        ...
        with patch("satellite_control.core.simulation.io.Path") as mock_path:
    ...
    def test_create_data_directories_creates_structure(self, simulation_io, tmp_path):
        ...
        with patch("satellite_control.core.simulation.io.Path") as mock_path_class:
            ...
            with patch(
                "satellite_control.core.simulation.io.datetime"
            ) as mock_datetime:
