...
class TestSimulationInitializerInitialize:
    ...
    @patch("satellite_control.core.simulation.initialization.MPCController")
    @patch(
        "satellite_control.core.simulation.initialization.create_state_validator_from_config"
    )
    @patch("satellite_control.core.simulation.initialization.create_data_logger")
    @patch(
        "satellite_control.core.simulation.initialization.create_mission_report_generator"
    )
    @patch("satellite_control.core.simulation.initialization.SimulationIO")
    @patch("satellite_control.core.simulation.context.SimulationContext")
    @patch(
        "satellite_control.visualization.simulation_visualization.create_simulation_visualizer"
    )
    @patch("satellite_control.core.cpp_satellite.CppSatelliteSimulator")
