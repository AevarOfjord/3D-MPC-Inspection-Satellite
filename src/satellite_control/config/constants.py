...
class _MPCDefaults:
    ...
    COAST_VEL_TOLERANCE: float = 0.02
    COAST_MIN_SPEED: float = 0.02
...
class Constants:
    ...
    OBSTACLE_WAYPOINT_STABILIZATION_TIME = ObstacleConstants.OBSTACLE_WAYPOINT_STABILIZATION_TIME
    OBSTACLE_FLYTHROUGH_TOLERANCE = ObstacleConstants.OBSTACLE_FLYTHROUGH_TOLERANCE
    OBSTACLE_AVOIDANCE_SAFETY_MARGIN = ObstacleConstants.OBSTACLE_AVOIDANCE_SAFETY_MARGIN
