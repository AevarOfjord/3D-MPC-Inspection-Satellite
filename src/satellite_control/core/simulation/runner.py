...
from satellite_control.config import AppConfig, SimulationConfig
...
class SatelliteMPCLinearizedSimulation:
    ...
    def log_physics_step(self):
        ...
        if not hasattr(self, "physics_logger_helper"):
            from satellite_control.core.simulation.logger import (
                SimulationLogger,
            )
    ...
    def step(self) -> None:
        ...
        if not hasattr(self, "loop"):
            ...
            if not hasattr(self, "context"):
                from satellite_control.core.simulation.context import (
                    SimulationContext,
                )
