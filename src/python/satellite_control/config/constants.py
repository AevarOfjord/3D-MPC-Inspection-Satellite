...
class _MPCDefaults:
    ...
    TRACKING_RECOVERY_ERROR_M: float = 0.12
    TRACKING_RECOVERY_CONTOUR_BOOST: float = 2.2
    TRACKING_RECOVERY_PROGRESS_SCALE: float = 0.65
    TRACKING_RECOVERY_ATTITUDE_SCALE: float = 0.5
...
class Constants:
    ...
    TRACKING_RECOVERY_ERROR_M = MPCDefaults.TRACKING_RECOVERY_ERROR_M
    TRACKING_RECOVERY_CONTOUR_BOOST = MPCDefaults.TRACKING_RECOVERY_CONTOUR_BOOST
    TRACKING_RECOVERY_PROGRESS_SCALE = MPCDefaults.TRACKING_RECOVERY_PROGRESS_SCALE
    TRACKING_RECOVERY_ATTITUDE_SCALE = MPCDefaults.TRACKING_RECOVERY_ATTITUDE_SCALE
