...
def _create_balanced_mpc() -> MPCParams:
    ...
    return MPCParams(
        ...
        tracking_recovery_error_m=Constants.TRACKING_RECOVERY_ERROR_M,
        tracking_recovery_contour_boost=Constants.TRACKING_RECOVERY_CONTOUR_BOOST,
        tracking_recovery_progress_scale=Constants.TRACKING_RECOVERY_PROGRESS_SCALE,
        tracking_recovery_attitude_scale=Constants.TRACKING_RECOVERY_ATTITUDE_SCALE,
...
def load_preset(preset_name: str) -> dict[str, Any]:
    ...
    return {
        "mpc": {
            ...
            "tracking_recovery_error_m": mpc.tracking_recovery_error_m,
            "tracking_recovery_contour_boost": mpc.tracking_recovery_contour_boost,
            "tracking_recovery_progress_scale": mpc.tracking_recovery_progress_scale,
            "tracking_recovery_attitude_scale": mpc.tracking_recovery_attitude_scale,
