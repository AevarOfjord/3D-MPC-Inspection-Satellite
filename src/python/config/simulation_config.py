...
class SimulationConfig:
    ...
    def get_mpc_params(self) -> dict[str, Any]:
        ...
        return {
            ...
            "Q_lag_default": self.app_config.mpc.Q_lag_default,
            "Q_velocity_align": self.app_config.mpc.Q_velocity_align,
            "Q_s_anchor": self.app_config.mpc.Q_s_anchor,
            "Q_smooth": self.app_config.mpc.Q_smooth,
            "Q_attitude": self.app_config.mpc.Q_attitude,
            "Q_axis_align": self.app_config.mpc.Q_axis_align,
