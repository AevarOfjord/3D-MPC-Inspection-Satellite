...
def temporary_log_level(logger_name: str, level: int):
    ...
    Usage:
        with temporary_log_level(" core.mpc_controller", logging.DEBUG):
...
def configure_module_log_levels(module_levels: dict[str, int]) -> None:
    ...
    Example:
        configure_module_log_levels({
            " core.mpc_controller": logging.DEBUG,
            " core.simulation": logging.INFO,
        })
    """
...
DEFAULT_MODULE_LEVELS: dict[str, int] = {
    " core.mpc_controller": logging.INFO,
    " core.simulation": logging.INFO,
    " control.mpc_controller": logging.INFO,
}
